...
const api = {
  ...
  clearExtractionCache: () => ipcRenderer.invoke("extraction-cache:clear"),
  clauseSkillStatus: (payload) => ipcRenderer.invoke("clause-skill:status", payload),
  clauseSkillAnalyze: (payload) => ipcRenderer.invoke("clause-skill:analyze", payload),
